...
<ul class="breadcrumbs">
  <li>
    <a href="?module=transaksisewa-edit?">Home</a></li>
  <li class="disabled">Edit Data Transaksi Sewa</li>
</ul>
</nav>
<form action="" method="post">
 ...
 <!-- field no -->
  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="small-6 cell">
      <input type="hidden" name="id" value="<?php echo $r['id']; ?>">
      <input type="text" name="jam_kembali_realisasi" placeholder="Jam Kembali Realisasi" value="<?php echo $r['jam_kembali_realisasi']; ?>" required>
    </div>
  </div>
  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="small-6 cell">
      <input type="date" name="denda" placeholder="Denda" value="<?php echo $r['denda']; ?>" required>
    </div>
  </div>
  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="small-6 cell">
      <input type="date" name="kilometer_kembali" placeholder="Kilometer Kembali" value="<?php echo $r['kilometer_kembali']; ?>" required>
    </div>
  </div>
  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="small-6 cell">
      <input type="date" name="BBM_kembali" placeholder="BBM Kembali" value="<?php echo $r['BBM_kembali']; ?>" required>
    </div>
  </div>
  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="small-6 cell">
      <input type="date" name="kondisi_mobil_kembali" placeholder="Kondisi Mobil Kembali" value="<?php echo $r['kondisi_mobil_kembali']; ?>" required>
    </div>
  </div>
  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="small-6 cell">
      <input type="date" name="biaya_kerusakan" placeholder="Biaya Kerusakan" value="<?php echo $r['biaya_kerusakan']; ?>" required>
    </div>
  </div>
